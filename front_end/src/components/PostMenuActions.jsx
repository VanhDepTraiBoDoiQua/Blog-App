...
const PostMenuActions = ({post}) => {
    ...
    const deleteMutation = useMutation({
        mutationFn: async () => {
            const token = await getToken();
            return axios.delete(`${import.meta.env.VITE_API_URL}/posts/${post.id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
