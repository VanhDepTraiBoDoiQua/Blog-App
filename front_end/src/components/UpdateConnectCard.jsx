...
const UpdateConnectCard = ({setUpdateConnect}) => {
    const queryClient = useQueryClient();

    const updateMutation = useMutation({
        mutationFn: (data) => {
            return axios.patch(`${import.meta.env.VITE_API_URL}/connect`, 
                data, 
    ...
    return (
        ...
        >
            <form onSubmit={handleUpdateConnect}>
                <h2 className="font-semibold mb-3">Connected Account</h2>
                <div className="mb-4">
                ...
                <button onClick={() => setUpdateConnect(false)} className="px-4 py-2 rounded-md hover:bg-gray-200">Cancel</button>
...
export default UpdateConnectCard;